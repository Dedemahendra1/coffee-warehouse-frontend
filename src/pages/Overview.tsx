...
const Overview = () => {
  ...
  const isLoading = loadingTransactions || loadingWarehouses || loadingOutlets || loadingProducts;
            ...
            <>
              ...
              <section className="grid grid-cols-2 gap-6">
                <div className="flex flex-col rounded-3xl p-[18px] gap-5 bg-white">
                  ...
                  <div className="flex flex-col gap-[6px]">
                    ...
                    <p className="font-medium text-sm text-monday-gray">
                      Hari ini: Rp {todayRevenue.toLocaleString("id")} ({todayTransactions.length} transaksi)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col rounded-3xl p-[18px] gap-5 bg-white">
                  ...
                  <div className="flex flex-col gap-[6px]">
                    <p className="font-semibold text-[32px]">{transactionList.length}</p>
                    <p className="font-medium text-lg text-monday-gray">
                      Total Transaksi
                    </p>
                    <p className="font-medium text-sm text-monday-gray">
              ...
              <section className="flex flex-col gap-5 flex-1 rounded-3xl p-[18px] bg-white">
                <h2 className="font-bold text-xl">Transaksi Terbaru</h2>

                {latestTransactions.length > 0 ? (
                  latestTransactions.map((tx) => (
                    <div
                      key={tx.id}
                      className="card-outlet flex flex-col rounded-2xl border border-monday-border"
                    >
                      ...
                      <div className="flex flex-col px-4 gap-5 py-5">
                        ...
                        >
                          <p className="font-semibold text-lg">
                            Produk ({tx.transaction_products.length})
                          </p>
                          <img
