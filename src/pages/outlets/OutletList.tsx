...
const OutletList = () => {
  const { data: outlets, isPending, isError, error } = useFetchOutlets(); // ✅ Use `isPending`

  if (isPending) return <p>Loading outlets...</p>;
          ...
          >
            ...
            >
              <div className="flex flex-col gap-[6px]">
                ...
                <p className="font-semibold text-lg text-monday-gray">
                  View and update your Outlets list here.
                </p>
              </div>
              <Link
                to={"/outlets/add"}
            ...
            <div id="Product-List" className="flex flex-col px-4 gap-5 flex-1">
              <div className="flex items-center justify-between">
                <p className="font-semibold text-xl">All Outlets</p>
              </div>
                    ...
                    <React.Fragment key={outlet.id}>
                      <div className="card flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <Link to={`/outlets/edit/${outlet.id}`}
