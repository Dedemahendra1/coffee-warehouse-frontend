...
const MyOutletProfile = () => {

  const [selectedProductId, setSelectedProductId] = useState<number | null>(
    null
  );

  const { data: outlet, isPending, isError, error } = useMyOutletProfile();
    ...
    return (
      <div className="flex bg-gray-100 min-h-screen">
        ...
        <main className="flex-1 p-8">
          <h1 className="text-2xl font-bold">My Outlet Profile</h1>
          <p>No outlet has been assigned to you.</p>
        </main>
      </div>
    );
  }
  ...
  if (isPending) {
    return <p className="p-8 text-gray-700">Loading outlet data...</p>;
  }

  if (isError) {
    return (
      <p className="p-8 text-red-500">
        Failed to load outlet: {error.message}
      </p>
    );
  }
          ...
          >
            <div className="flex items-center gap-6 h-[92px] bg-white w-full rounded-3xl p-[18px]">
              <div className="flex flex-col gap-[6px] w-full">
                <h1 className="font-bold text-2xl">Manage Outlets</h1>
              </div>
          ...
          <main className="flex flex-col gap-6 flex-1">
            ...
            >
              ...
              <div className="flex flex-col gap-2 flex-1">
                <p className="font-semibold text-xl">{outlet.name}</p>
                ...
                <div className="flex flex-col gap-[6px]">
                  <p className="flex items-center gap-[6px]">
                    ...
                    <span className="font-semibold text-2xl">
                      {outlet.products.length} Total Products
                    </span>
                  </p>
...
export default MyOutletProfile;
